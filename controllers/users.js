...
const userPost=async(req,res)=>{
    ...
    const usuario=await Usuario.create({contrasena:documento,email,nombre,apellido, documento, fechaNacimiento, genero,telefono, direccion}); 
